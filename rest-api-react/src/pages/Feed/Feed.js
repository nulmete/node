      ...
      .then(resData => {
        ...
        this.setState({
          posts: resData.data.posts.posts.map(post => {
            return {
              ...post,
              // imageUrl is the field provided from the backend
              // imagePath is saved as 'image' field in FeedEdit component
    ...
    .then(resData => {
      ...
      this.setState(prevState => {
        ...
        if (prevState.editPost) {
          ...
          // update total posts
          updatedTotalPosts++;
          // remove 1 element and add a new one at the beginning
